...
Files: macbook.glb [629.72KB] > /Users/lasyajetti/Desktop/gsap_apple/gsap_apple/public/models/macbook-transformed.glb [627.9KB] (0%)
...
import macstore from '../../src/store/index.js';
import {nochanges} from "../../src/constants/index.js";
  ...
  const { nodes, materials, scene} = useGLTF(import.meta.env.BASE_URL +'/models/macbook-transformed.glb')
    ...
    useEffect(() => {
        scene.traverse((child) => {
            if (child.isMesh) {
                if (!nochanges.includes(child.name)) {
